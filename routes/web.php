...
Route::post('/producto/salvar',[ProductoController::class, 'guardar'])->name('producto.guardar');

Route::get('/productos/editar/salvar/{id}',[ProductoController::class, 'salvarEditar'])->name('producto.editar.guardar');
